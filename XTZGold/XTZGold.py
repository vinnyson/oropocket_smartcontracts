...
TZIP16_Metadata_Base = {
    "name"          : "Oropocket Gold",
    "description"   : "Gold tokenized on Tezos",
    "authors"       : [
...
if "templates" not in __name__:
    ...
    def test():
            ...
            sp.some(
                sp.record(
                    ...
                    token_info = sp.map({
                        ...
                        "name"        : sp.utils.bytes_of_string("Oropocket Gold"),
                        "symbol"      : sp.utils.bytes_of_string("XTZGold"),
                        "thumbnailUri"        : sp.utils.bytes_of_string('https://oropocket.com/unifarm/assets/icons/oro-gold.png')
                    })
                )
            )
        )
        ...
        scenario.verify(
            c1.data.metadata[""] == sp.utils.bytes_of_string("ipfs://QmYA6osSz1pzy3YviBV4WQvs8W4L7zCNedVXL3UsiapSsP")
        )
